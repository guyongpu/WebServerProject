...
#ifndef WEBSERVER_V5_0_REQUESTDATA_H
#define WEBSERVER_V5_0_REQUESTDATA_H
...
/**
 * RALL锁机制，将lock声明为静态成员变量，相当于是一个全局变量，无论对象是否创建都存在该变量。
 * 且不管创建多少变量，该对象都只存在一份。
 */
...
#endif //WEBSERVER_V5_0_REQUESTDATA_H
